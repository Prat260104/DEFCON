...
export function createStatusCommand(): Command {
  ...
  cmd.description("Display the current status of APL and its monitoring adapters").action(() => {
    ...
    console.log(
      `  Inbox Path:      ${inboxPath} (${inboxExists ? `Active, ${inboxSize} bytes` : "Not created yet"})`,
    );
    console.log(
